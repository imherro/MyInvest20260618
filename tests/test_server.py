...
class ServerPayloadTests(unittest.TestCase):
    ...
    def test_footer_links_include_system_and_channels(self):
        ...
        self.assertEqual(
            ["invest", "market", "theme", "shadow", "leader", "etf", "picking", "stock", "position"],
        ...
        self.assertEqual("https://etf.okbbc.com/", links[5]["url"])
        self.assertEqual("https://picking.okbbc.com/", links[6]["url"])
        self.assertEqual("https://stock.okbbc.com/", links[7]["url"])
