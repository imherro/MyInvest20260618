...
Footer 显示当前时间、上证指数实时点位、涨跌额、涨跌幅，以及首页、市场、周期、主线、龙头、影子、操作、ETF、个股、短线、选股、十倍链接。上证指数链接到 `https://xueqiu.com/S/SH000001` 并新窗口打开；导航链接仍在当前页打开。
...
Header 显示 MyInvest 品牌，以及首页、市场、周期、主线、龙头、影子、操作、ETF、个股、短线、选股、十倍导航链接；所有导航链接在当前页打开。
